...
?>
<div class="" style="background-color: rgb(30, 126, 52); color: #fff; padding: 10px 10px 0 10px; border-radius: 5px;"><h5 class="card-title">Booking History</h5></div>
 <div class="container">
      <div class="row">
  <?php
$query= "SELECT * FROM tbl_rent WHERE user_id='$id' ";
...
$select_user="SELECT * FROM tbl_register WHERE id='$id'";
  ...
  <div class="col-sm-4">
    <div class="card card-primary">
      ...
      <div class="card-body">
        ...
        <p class="card-text"><b>Total Charge: Rs. <?php echo $price; ?>(Including Driver)</b></p>
