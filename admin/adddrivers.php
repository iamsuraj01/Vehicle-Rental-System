                    ...
                    <div class="panel panel-default">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="" ><a href="addvehicle.php">Add Vehicles</a></li>
                             <li class="active" ><a href="adddrivers.php">Add Drivers</a></li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="">
                                <div class="panel-body">
                                    <a href="service_add.php" class="btn btn-sm btn-warning" title="Add">Add</a>    
                                    <table class="table table-striped table-bordered">
                                      ...
                                      <td class="text-center" width="14%>Address</td>
                                        ...
                                        <td class="text-center" width="14%" style="color:red">Phone.No</td>
                                         <td class="text-center" width="14%" style="color:red">Rate</td>
